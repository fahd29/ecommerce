...
class GetProductDto extends GetProductEntity{
  ...
  GetProductDto.fromJson(dynamic json) {
    ...
    category = json['category'] != null ? CategoriesOrBrandResponse.fromJson(json['category']) : null;
    brand = json['brand'] != null ? CategoriesOrBrandResponse.fromJson(json['brand']) : null;
