...
class FavouriteItemDetails extends StatelessWidget {
   FavouriteItemDetails({required this.product, super.key});
      ...
      children: [
        ...
        Row(
          children: [
            ...
            //       color: product.brand.data.h, shape: BoxShape.circle),
            // ),
            // CustomTextWgt(
            //   data: (product.category!.results!.colorName ),
